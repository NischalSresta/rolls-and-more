...
function App(){
 ...
 const hasComboItem=cart.some(line=>line.comboEligible)
 ...
 const openCombo=()=>{if(hasComboItem){setCartOpen(true);return}setToast('Add a burger or wrap first, then upgrade it in your bag.')}
 useEffect(()=>{
